def Weather():
    ...
    def plot_line(days, min_t, max_t):
        ...
        plt.plot(days, max_t, color='black', linestyle='solid', linewidth=1, marker='o', markerfacecolor='#e9c46a',
                markersize=7)
        plt.plot(days, min_t, color='black', linestyle='solid', linewidth=1, marker='o', markerfacecolor='#219ebc',
                markersize=7)
